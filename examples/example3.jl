...
factor = DenseAxisArray(Float64[30 50; 20 20], goods, factors)
...
RA = add!(m, Consumer(:RA, benchmark=120.))
...
@demand(m, RA, 1., [Demand(PU, 150)], [Endowment(PF[:l], :(50 * $(endow[:l]))), Endowment(PF[:k], :(70 * $(endow[:k])))])
