...
#A replication of the JPMGE from https://www.gams.com/34/docs/UG_MPSGE_Intro.html#UG_MPSGE_Intro_Appendix_jpmge
    ...
    solve!(m)
    @test MPSGE.Complementarity.result_value(m._jump_model[:X][:s1]) ≈ two_by_two_jpmge["X.s1","Y=6.4"] # 0.99692562
    @test MPSGE.Complementarity.result_value(m._jump_model[:X][:s2]) ≈ two_by_two_jpmge["X.s2","Y=6.4"] # 1.09975731
    @test MPSGE.Complementarity.result_value(m._jump_model[:P][:g1]) ≈ two_by_two_jpmge["P.g1","Y=6.4"] # 1.01306317
    @test MPSGE.Complementarity.result_value(m._jump_model[:P][:g2]) ≈ two_by_two_jpmge["P.g2","Y=6.4"] # 0.99467892
    @test MPSGE.Complementarity.result_value(m._jump_model[:PF][:l]) ≈ two_by_two_jpmge["PF.labor","Y=6.4"] # 0.97665932
    @test MPSGE.Complementarity.result_value(m._jump_model[:PF][:k]) ≈ two_by_two_jpmge["PF.capital","Y=6.4"] # 1.0513495
    @test MPSGE.Complementarity.result_value(m._jump_model[:Y]) ≈ two_by_two_jpmge["Y._","Y=6.4"] # 6.4
    @test MPSGE.Complementarity.result_value(m._jump_model[Symbol("P[g1]‡X[s1]")]) ≈ 6.0271570795595 # two_by_two_jpmge["P.g1","Y=6.4"] implicit don't match
    @test MPSGE.Complementarity.result_value(m._jump_model[Symbol("P[g2]‡X[s1]")]) ≈ 1.97259368637181 # two_by_two_jpmge["P.g1","Y=6.4"] implicit don't match
    @test MPSGE.Complementarity.result_value(m._jump_model[Symbol("P[g1]‡X[s2]")]) ≈ 2.03066186698742 # two_by_two_jpmge["P.g1","Y=6.4"] implicit don't match
    @test MPSGE.Complementarity.result_value(m._jump_model[Symbol("P[g2]‡X[s2]")]) ≈ 9.96905522562002 ##note - digits after 9.969 added from MPSGE.jl results bc GAMS not showing  # two_by_two_jpmge["P.g1","Y=6.4"] implicit don't match
    @test MPSGE.Complementarity.result_value(m._jump_model[Symbol("P[g1]†X[s1]")]) ≈ 3.98197684247759 # two_by_two_jpmge["P.g1","Y=6.4"] implicit don't match
    @test MPSGE.Complementarity.result_value(m._jump_model[Symbol("P[g2]†X[s1]")]) ≈ 2.02778707866119 # two_by_two_jpmge["P.g1","Y=6.4"] implicit don't match
    @test MPSGE.Complementarity.result_value(m._jump_model[Symbol("PF[l]†X[s1]")]) ≈ 1.03260012599366 # two_by_two_jpmge["P.g1","Y=6.4"] implicit don't match
    @test MPSGE.Complementarity.result_value(m._jump_model[Symbol("PF[k]†X[s1]")]) ≈ 0.959241925360056 # two_by_two_jpmge["P.g1","Y=6.4"] implicit don't match
    @test MPSGE.Complementarity.result_value(m._jump_model[Symbol("P[g1]†X[s2]")]) ≈ 1.96980110341978 # two_by_two_jpmge["P.g1","Y=6.4"] implicit don't match
    ...
    @test MPSGE.Complementarity.result_value(m._jump_model[:X][:s1]) ≈ two_by_two_jpmge["X.s1","P(\"g1\")=1"] # 0.996925617439043 # not quite…0.99692552
    @test MPSGE.Complementarity.result_value(m._jump_model[:X][:s2]) ≈ two_by_two_jpmge["X.s2","P(\"g1\")=1"] # 1.09975731474277 # not quite…1.09975733
    @test MPSGE.Complementarity.result_value(m._jump_model[:P][:g1]) ≈ two_by_two_jpmge["P.g1","P(\"g1\")=1"] # 1
    @test MPSGE.Complementarity.result_value(m._jump_model[:P][:g2]) ≈ two_by_two_jpmge["P.g2","P(\"g1\")=1"] # 0.981852806861767#note - digits after 0.9818528 added from MPSGE.jl results bc GAMS not showing
    @test MPSGE.Complementarity.result_value(m._jump_model[:PF][:l]) ≈ two_by_two_jpmge["PF.labor","P(\"g1\")=1"] atol=0.0000001 # 0.964065561173485 # not quite…0.9640655431257426 
    @test MPSGE.Complementarity.result_value(m._jump_model[:PF][:k]) ≈ two_by_two_jpmge["PF.capital","P(\"g1\")=1"] #atol=0.000001 # 1.0377926401152 #note -not quite... 1.037792634346030 
    ...
    @test MPSGE.Complementarity.result_value(m._jump_model[:X][:s1]) ≈ two_by_two_jpmge["X.s1","PF(\"labor\")=1"] # 0.996925617406936# not quite…0.9969255
    @test MPSGE.Complementarity.result_value(m._jump_model[:X][:s2]) ≈ two_by_two_jpmge["X.s2","PF(\"labor\")=1"] #1.09975731471521# not quite…1.09975741
    @test MPSGE.Complementarity.result_value(m._jump_model[:P][:g1]) ≈ two_by_two_jpmge["P.g1","PF(\"labor\")=1"] #1.03727385383628# not quite…1.03727374
    @test MPSGE.Complementarity.result_value(m._jump_model[:P][:g2]) ≈ two_by_two_jpmge["P.g2","PF(\"labor\")=1"] #1.01845024488441# not quite…1.01845009
    @test MPSGE.Complementarity.result_value(m._jump_model[:PF][:l]) ≈ two_by_two_jpmge["PF.labor","PF(\"labor\")=1"] #1
    @test MPSGE.Complementarity.result_value(m._jump_model[:PF][:k]) ≈ two_by_two_jpmge["PF.capital","PF(\"labor\")=1"] #1.07647517126301# not quite…1.07647514
...
# All indexes and data as above
    ...
    solve!(m)
    @test MPSGE.Complementarity.result_value(m._jump_model[:X][:s1]) ≈ two_by_two_jpmge["X.s1","D_elas=0,Y=6.4"] # 1.00695565
    @test MPSGE.Complementarity.result_value(m._jump_model[:X][:s2]) ≈ two_by_two_jpmge["X.s2","D_elas=0,Y=6.4"] # 1.0946557
    @test MPSGE.Complementarity.result_value(m._jump_model[:P][:g1]) ≈ two_by_two_jpmge["P.g1","D_elas=0,Y=6.4"] # 1.01368185
    @test MPSGE.Complementarity.result_value(m._jump_model[:P][:g2]) ≈ two_by_two_jpmge["P.g2","D_elas=0,Y=6.4"] # 
    ...
    @test MPSGE.Complementarity.result_value(m._jump_model[:X][:s1]) ≈ two_by_two_jpmge["X.s1","D_elas=0,P(\"g1\")=1"] atol = 0.0000001 # 
    @test MPSGE.Complementarity.result_value(m._jump_model[:X][:s2]) ≈ two_by_two_jpmge["X.s2","D_elas=0,P(\"g1\")=1"] # 
    @test MPSGE.Complementarity.result_value(m._jump_model[:P][:g1]) ≈ two_by_two_jpmge["P.g1","D_elas=0,P(\"g1\")=1"] # 
    @test MPSGE.Complementarity.result_value(m._jump_model[:P][:g2]) ≈ two_by_two_jpmge["P.g2","D_elas=0,P(\"g1\")=1"] # 
    ...
    @test MPSGE.Complementarity.result_value(m._jump_model[:X][:s1]) ≈ two_by_two_jpmge["X.s1","D_elas=0,PF(\"l\")=1"] # 
    @test MPSGE.Complementarity.result_value(m._jump_model[:X][:s2]) ≈ two_by_two_jpmge["X.s2","D_elas=0,PF(\"l\")=1"] # 
    @test MPSGE.Complementarity.result_value(m._jump_model[:P][:g1]) ≈ two_by_two_jpmge["P.g1","D_elas=0,PF(\"l\")=1"] # 
    @test MPSGE.Complementarity.result_value(m._jump_model[:P][:g2]) ≈ two_by_two_jpmge["P.g2","D_elas=0,PF(\"l\")=1"] # 
...
# All indices and data as above
    ...
    solve!(m)
    @test MPSGE.Complementarity.result_value(m._jump_model[:X][:s1]) ≈ two_by_two_jpmge["X.s1","D_elas=2,Y=6.4"] # 
    @test MPSGE.Complementarity.result_value(m._jump_model[:X][:s2]) ≈ two_by_two_jpmge["X.s2","D_elas=2,Y=6.4"] # 
    @test MPSGE.Complementarity.result_value(m._jump_model[:P][:g1]) ≈ two_by_two_jpmge["P.g1","D_elas=2,Y=6.4"] # 
    @test MPSGE.Complementarity.result_value(m._jump_model[:P][:g2]) ≈ two_by_two_jpmge["P.g2","D_elas=2,Y=6.4"] # 
    ...
    @test MPSGE.Complementarity.result_value(m._jump_model[:X][:s1]) ≈ two_by_two_jpmge["X.s1","D_elas=2,P(\"g1\")=1"] # 
    @test MPSGE.Complementarity.result_value(m._jump_model[:X][:s2]) ≈ two_by_two_jpmge["X.s2","D_elas=2,P(\"g1\")=1"] # 
    @test MPSGE.Complementarity.result_value(m._jump_model[:P][:g1]) ≈ two_by_two_jpmge["P.g1","D_elas=2,P(\"g1\")=1"] # 
    @test MPSGE.Complementarity.result_value(m._jump_model[:P][:g2]) ≈ two_by_two_jpmge["P.g2","D_elas=2,P(\"g1\")=1"] # 
    ...
    @test MPSGE.Complementarity.result_value(m._jump_model[:X][:s1]) ≈ two_by_two_jpmge["X.s1","D_elas=2,PF(\"l\")=1"] # 
    @test MPSGE.Complementarity.result_value(m._jump_model[:X][:s2]) ≈ two_by_two_jpmge["X.s2","D_elas=2,PF(\"l\")=1"] # 
    @test MPSGE.Complementarity.result_value(m._jump_model[:P][:g1]) ≈ two_by_two_jpmge["P.g1","D_elas=2,PF(\"l\")=1"] # 
    @test MPSGE.Complementarity.result_value(m._jump_model[:P][:g2]) ≈ two_by_two_jpmge["P.g2","D_elas=2,PF(\"l\")=1"] # 
